...
namespace main
{
	public partial class Menu : Node
	{
		...
		public override void _Ready()
		{
			...
			Button hostBtn = GetNode<Button>("MenuContainer/HostBtn");
			Button joinBtn = GetNode<Button>("MenuContainer/JoinBtn");

			Label hostingIP = new Label();
			hostingIP.Text = $"Your IP: {GetLocalIPAddress()}";
			AddChild(hostingIP);

			_ipInput = GetNode<LineEdit>("MenuContainer/HostIPInput");
